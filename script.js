...
// Fetch the JSON data from rates.json
fetch('data/rates.json')
    .then(response => response.json())
    .then(ratesData => {
        // Now you have 'ratesData,' and you can create links based on it
        ...
        // Continue with your simulation setup here
    ...
    .catch(error => console.error('Error fetching rates.json:', error));
